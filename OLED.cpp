...
display.display();
    ...
    if (slotNo == 1U)
      ...
      display.fillRect(0,OLED_LINE2,display.width(),55,BLACK);
      display.setCursor(5,OLED_LINE2);
      display.setTextSize(2);
      display.printf("%s %s",type,src.c_str());
      display.setCursor(5,OLED_LINE3);
      display.setTextSize(1);
      display.printf("%s%s%s", group ? "TG" : "", dst.c_str()," DMRGateway");
//     display.setCursor(0,OLED_LINE4);
//     display.setTextSize(1);
//     display.printf("%s",m_ipaddress.c_str());
...
void COLED::clearDMRInt(unsigned int slotNo)
{
    if (slotNo == 1U)
      ...
      {
      display.fillRect(0, OLED_LINE2, display.width(), 90, BLACK);
      display.setCursor(30, OLED_LINE2);
      display.setTextSize(2);
      display.print("DMR RX");
      }
